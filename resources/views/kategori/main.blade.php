        ...
        <aside class="main-sidebar sidebar-dark-orange elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/dataStudio" class="nav-link {{ $title == 'Data Studio' ? 'active' : '' }} ">
                        ...
                        <li class="nav-item">
                            <a href="/dataTransaksi"
                                class="nav-link {{ $title == 'Data Transaksi' ? 'active' : '' }} ">
                        ...
                        <li class="nav-item">
                            <a href="dataWithdraw"
                                class="nav-link {{ $title == 'Data Withdraw' ? 'active' : '' }} ">
                        ...
                        <li
                            class="nav-item {{ $title == 'Akun Admin' || $title == 'Akun Pembayaran' ? 'menu-open' : '' }} ">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @foreach ( DB::table('kategoris')->get() as $kategori)
                                    <li class="nav-item">
                                        <a href="/detailKategori/{{ $kategori->id }}/show"
                                            class="nav-link ">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>{{ $kategori->name }}</p>
                                        </a>
                ...
                <div class="modal fade" id="modal-export">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="button" data-dismiss="modal" class="btn btn-success"><i
                                        class="fa-solid fa-file-export mr-2"></i>Export PDF</button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <h4 style="color: orangered ;">Rp. 100.000</h4>
                                    <div class="row col">
                                        <div>
                                            <p>Status : </p>
                                        </div>
                                    ...
                                    <div class="row col">
                                        <table>
                                            <tr>
                                                <td class="pr-3" rowspan="3"><i
                                                        class="fa-solid fa-building-columns fa-lg"
